...
```{r,echo=FALSE, message=FALSE, warning=FALSE}
 cv_mat %>% kbl(caption = "", booktabs = T) %>%
  kable_styling(latex_options = c("scale_down",full_width = T))
```

## Prediction performance & model complexity
```{r,echo=FALSE, message=FALSE, warning=FALSE}
m_comp %>% kbl(caption = "", booktabs = T) %>%
  kable_styling(latex_options = c("scale_down",full_width = T))
```

## Averaged RMSE on test samples
```{r,echo=FALSE, message=FALSE, warning=FALSE}
kfold
```
